      ...
      <div class={isMobile ? "infoMobile" : "info"}>
        ...
        >
          ...
          <p class={isMobile ? "section-text-mobile" : "section-text"}>
            I am currently employed as a software engineer for the{" "}
            <Link
              color="teal.500"
            ...
            ,&nbsp;and have completed both freelance and contract work for
            private clients and start-ups. For further information, please refer
            to my&nbsp;
            <Link
              color="teal.500"
              href={CV}
            ...
            .
            <br /> <br />
            In terms of my university work, some examples of relevant courses I
            have taken include:
