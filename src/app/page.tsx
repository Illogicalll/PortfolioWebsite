        ...
        <div className="space-y-12 w-full py-12">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Check out some of my favourite work
                </h2>
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Here is a selection of projects that I have worked on over the
                  years. This includes both client work and work completed for
          ...
          <div className="flex flex-col gap-y-3">
            <div className="max-w-[800px] mx-auto w-full">
              {DATA.bigprojects.map((project, id) => (
                <BlurFade
                  key={project.title}
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                I&apos;m always on the lookout for new opportunities! If you
